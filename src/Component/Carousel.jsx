...
//     props.onAddToWishlist(props); // Pass the car data to parent when liked
//   }
...
//             </div>
//             <div className="col">
//               <h3 className="text-danger fs-4 text-center mt-1" id="count">
//                 {count}/day
//               </h3>
//             </div>
//             <div className="col-3">
...
//             <div className="col-4">
//               <h3 className="text-center fs-5 fw-bold">{props.seats}</h3>
//             </div>
//             <div className="col-4">
//               <h3 className="text-center fs-5 fw-bold">{props.trans}</h3>
//             </div>
//             <div className="col-4">
//               <h3 className="text-center fs-5 fw-bold">{props.fuel}</h3>
//             </div>
//           </div>
//           <div className="row p-2">
//             <div className="col-4">
//               <h3 className="text-center fs-5 fw-bold">{props.year}</h3>
//             </div>
//             <div className="col-4">
//               <h3 className="text-center fs-5 fw-bold">{props.setting}</h3>
//             </div>
//             <div className="col-4">
//               <h3 className="text-center fs-5 fw-bold">{props.km}</h3>
//             </div>
//           </div>
//           <Link className="btn btn-dark form-control mt-2 mb-3" type="button" to="checkout">
//             Book Now
//           </Link>
//         </div>
//       </div>
...
const Carousel = () => {
  ...
  return (
    ...
    <div className="container mt-4">
      <h2 className="text-black text-center fs-1 fw-bold pb-5">Vehicle <span className="text-danger">Categories</span></h2>
