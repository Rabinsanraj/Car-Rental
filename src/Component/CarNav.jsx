        ...
        <div className="container-fluid w-100"  style={{backgroundImage: `url(${PassLight})`,
            backgroundSize:"cover",backgroundPosition:"center",backgroundRepeat:"no-repeat"}}>
                ...
                <p className="d-flex justify-content-center text-white gap-1 pt-1"style={{paddingBottom:"70px"}}>
                    <Link className='text-white fw-bold text-decoration-none' to={props.pagename1}>{props.link1}</Link>/
                    <Link className='text-white fw-bold text-decoration-none' to={props.pagename2}>{props.link2}</Link>/
                    <Link className='text-white fw-bold text-decoration-none' to={props.pagename3}>{props.link3}</Link>
                </p>
        </div>
    );
}
