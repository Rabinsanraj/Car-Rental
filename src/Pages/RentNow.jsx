        ...
        <div className="row text-center gx-5 gy-3 mt-5">
          {["hourly", "day 8", "weekly", "monthly"].map((type) => (
            <div className="col-md-3" key={type}>
              <div className="card">
                <label className="container selfdriver pt-3 pb-3 border border-3 text-center w-100"
                  style={{ backgroundColor: bookingType === type ? "#aee0af" : "white", cursor: "pointer",}}
                  onClick={() => handleSelect(type)}>
                  <input type="radio" name="timetoggle" style={{ transform: "scale(1.5)", accentColor: "green" }}
                    checked={bookingType === type}readOnly/>
