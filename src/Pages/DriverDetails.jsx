        ...
        <div className="row justify-content-center align-content-center">
          <div className="col-md-5 pb-5">
            <label className="container selfdriver pt-3 pb-3 border border-3 rounded-5 text-center w-100"
              style={{backgroundColor: selectedDriver === "self driver" ? "#aee0af" : "white",
                cursor: "pointer",}}onClick={() => handleSelect("self driver")}>
      ...
      <div className="container-fluid">
        <form className="pt-2">
          ...
          <div className="container pt-5 d-flex align-items-center justify-content-center">
            <button type="button"className="form-control w-50 bg-dark text-center
          text-light fs-3 fw-bold" onClick={handleDataChangeDriver}>Submit</button>
          </div>

          <div className="container pt-5 d-flex align-items-center justify-content-center">
            <button type="button" className={`form-control ${formSubmitted ? "bg-warning" : "bg-danger"
              } text-center text-light w-50 fs-3 fw-bold`}onClick={handleSubmitPayment}>Go To Pay</button>
          </div>
        </form>
      </div>
    </>
