...
function Home() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const { carType, pickupLocation, dropLocation, pickupDate, pickupTime, dropDate, dropTime } = formData;

    if (!carType || !pickupLocation || !dropLocation || !pickupDate || !pickupTime || !dropDate || !dropTime) {
    ...
    <>
        ...
        <div className="container-fluid pb-5 d-flex">
          <div className="w-auto pt-4">
            <div className="card-body h1-form p-4" style={{
              backgroundColor: "#050563", borderRadius: "15px", opacity: "90%",
      ...
      <div className="container-fluid pt-3 pb-5">
        <div className="row row-cols-md-2">
          <div className="col-md-7 text-center">
            <h1 className="pt-3 fw-bold" style={{ color: "black" }}><span style={{ color: "red" }}>About</span> Easy Car Rent</h1>
            <div className="container-fluid pt-5">
              <div className="row gy-4">
                <div className="col-md-6">
                  <div className="card" style={{
                    minHeight: "260px", borderRadius: "20px", boxShadow: "5px 5px 10px rgba(0, 0, 0, 0.5)"
                  }}>
              ...
              <div className="row pt-4">
                ...
                <div className="col-md-6 pt-3">
                  <div className="card p-3 border-0 ps-5">
                    <div className="row">
                      <div className="col-1"><i className="bx bx-check fs-4 p-1 rounded" style={{ backgroundColor: "red" }}></i></div>
          ...
          <div className="col-md-5" style={{
            backgroundImage: `url(${KeyInHand})`, backgroundSize: "cover", height: "80vh", position: "relative",
          }}>
            <img src={ManONCar} style={{ width: "93%", position: "absolute", bottom: "0", left: "7%", transform: "translateY(17%)" }} />
          </div>
        </div>
      </div>
      ...
      <div className="container-fluid mt-1 mb-3" style={{
        ...
        <div className="text-container text-end" style={{ paddingTop: "100px", paddingBottom: "100px", textShadow: "3px 3px 5px black" }}>
          ...
          <h1 className="display-6 fw-bold lh-base" style={{ color: "white" }}>Interested in Renting?</h1>
          <h1 className="display-6 fw-bold lh-base" style={{ color: "white" }}>Don't hesitate and <span style={{ color: "red" }}>SEND</span> us a <span className="display-4 fw-bold lh-base" style={{ color: "red" }}>MESSAGE</span></h1>
          <div className="row row-cols-md-2 pt-5">
            <div className="col text-center">
              <button className="btn text-white fs-4 fw-bold" style={{
                backgroundColor: "#ff1b1b", borderRadius: "25px", textShadow: "3px 3px 5px black"
              }}>Whatsapp</button>
            </div>
            <div className="col text-center">
              <Link to="contact" className="btn text-white fs-4 fw-bold" style={{
                backgroundColor: "#ff1b1b", borderRadius: "25px"
              }}>Contact Us</Link>
            </div>
          </div>
        </div>
